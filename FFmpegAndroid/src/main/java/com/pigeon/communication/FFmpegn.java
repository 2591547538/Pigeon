...
class FFmpegn extends AsyncTask<Void, String, CommandResult> {

    private final String[] cmd;
    private final FFmpegh ffmpegExecuteResponseHandler;
    ...
    FFmpegn(String[] cmd, long timeout, FFmpegh ffmpegExecuteResponseHandler) {
        this.cmd = cmd;
